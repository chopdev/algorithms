...
class TopologicalSortDFSTest {
    ...
    private TopologicalSortDFS topologicalSortDFS = new TopologicalSortDFS();
    ...
    public void getInOrderSimple() {
        ...
        // act
        List<Integer> res = topologicalSortDFS.getInOrder(graph);
        // assert
    ...
    public void getInOrder_Looped() {
        ...
        assertThrows(IllegalArgumentException.class, () -> topologicalSortDFS.getInOrder(graph));
    }
